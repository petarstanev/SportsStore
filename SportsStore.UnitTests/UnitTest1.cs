...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Menu_GivenSelectedCategory_SetSelectedCategory()
        {
            // Arrange
            Mock<IProductRepository> mock = new Mock<IProductRepository>();
            mock.Setup(m => m.Products).Returns(new Product[] {
            ...
            // Act          
            var selectedCategory = (string) target.Menu("Apples").ViewBag.SelectedCategory;
            // Assert          
            Assert.AreEqual("Apples", selectedCategory);
        }
